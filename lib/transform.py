# https://raw.githubusercontent.com/pytorch/vision/release/0.11/torchvision/models/detection/transform.py
import math
import torch
import torchvision
...
class GeneralizedRCNNTransform(nn.Module):
    ...
    def postprocess(self,
        ...
        if self.training:
            return result
        #print(result)
        #print("result mask shape: ", result[0]['masks'].shape)
        for i, (pred, im_s, o_im_s) in enumerate(zip(result, image_shapes, original_image_sizes)):
            ...
            if "masks" in pred:
                ...
                #print("mask here shape: ", masks[0].shape)
                try:
                    result[i]["masks"] = masks[0]
                except:
                    result[i]["masks"] = 0
